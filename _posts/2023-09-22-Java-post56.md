...
NotEmpty.userVo.email = 사용자 이름은 필수 입니다.
Email.uerVo.email= 사용자 이름은 2~8자이어야 합니다.

NotEmpty.userVo.password = 사용자 이름은 필수 입니다.
Length.uerVo.password= 사용자 이름은 2~8자이어야 합니다.
