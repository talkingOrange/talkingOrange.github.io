...
public class ArrayExam2 {
	...
	public static void main(String[] args) {
		int i = 5;
		int[] arr = new int[] {10,20,30}; // {10,20,30} : 배열상수 or 배열리터럴 -> 변수 선언, 초기화시에만 사용
		
		// Java는 배열을 255차원까지 지원한다. int[][][][][][][][][][]...
		int[][] arr2 = new int[][] {{10,20},{10,0},{50,80}};
		
		System.out.println(arr2[1][1]);
		
		//첫 부분의 사이즈만 확정해주면, 뒤에 부분의 사이즈는 지정하지 않아도 괜찮다.
		int[][] arr3 = new int[4][];
		arr3[0]= new int[3];
		arr3[1] = new int[2];
		arr3[0][0] = 80;
...
public class ScannerExam {
	...
	public static void main(String[] args) {
		...
		//next? 공백문자(space,enter,tab)를 기준으로 분리, 입력을 의미한다.
