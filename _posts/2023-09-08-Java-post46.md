...
![image](https://github.com/talkingOrange/talkingOrange.github.io/assets/88815795/cc7db55d-8075-4558-9d97-7e5c1b21364a)
...
<details>
  <summary>res. redirect:/user?a=joinsuccess (join이 완료 되었다는 응답으로 이동시켜준다.)</summary>
...
<details>
  <summary>req3. /user?a=joinsuccess</summary>
...
<details>
  <summary>controller의 join문을 단순하고 편하게 만들어보자.</summary>
